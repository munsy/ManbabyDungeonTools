...
NDT.dungeonTotalCount[dungeonIndex] = {normal=305,teeming=335,teemingEnabled=true}
NDT.dungeonBosses[dungeonIndex] = { --Cathedral of Eternal Night
	[2] = {
		[1] = {
			["name"] = "Agronox",
			["encounterID"] = 1905,
...
NDT.dungeonEnemies[dungeonIndex] = { --Cathedral of Eternal Night
	[1] = {
