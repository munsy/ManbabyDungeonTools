...
local pi = math.pi
NDT.dungeonTotalCount[dungeonIndex] = {normal=150,teeming=180,teemingEnabled=true}
NDT.dungeonBosses[dungeonIndex] = {--Maw of Souls
	[1] = {
		[1] = {
...
NDT.dungeonEnemies[dungeonIndex] = { --Maw of Souls
	[1] = {
