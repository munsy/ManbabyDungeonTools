...
local pi = math.pi
NDT.dungeonTotalCount[dungeonIndex] = {normal=392,teeming=466,teemingEnabled=true}
NDT.dungeonBosses[dungeonIndex] ={ --The Arcway
    [1] = {
        [1] = {
            ["name"] = "Ivanyr",
            ["health"] = 99914542,
...
NDT.dungeonEnemies[dungeonIndex] = { --The Arcway
    [1] = {
