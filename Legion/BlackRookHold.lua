...
local pi = math.pi
NDT.dungeonTotalCount[dungeonIndex] = { normal=300, teeming=360, teemingEnabled=true}
NDT.dungeonBosses[dungeonIndex] = {--Black Rook Hold
	[1] = {
		[1] = {
...
NDT.dungeonEnemies[dungeonIndex] = { --Black Rook Hold
	[1] = {
